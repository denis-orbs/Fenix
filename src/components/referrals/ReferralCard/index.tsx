...
const ReferralCard = ({ title, img, description }: ReferralCardProps) => {
  return (
    <div
      className="mx-auto relative group transition-colors duration-300 ease-in-out hover:border hover:border-solid hover:border-outrageous-orange-400 after:content-[''] after:bg-gradient-to-r after:from-outrageous-orange-500 after:to-festival-500 after:w-full after:h-full  after:md:max-w-[362px] after:top-0 after:left-0 after:z-10 after:rounded-xl after:opacity-0 after:transition-all hover:after:opacity-80 after:max-h-[240px] after:absolute cursor-pointer bg-shark-400 bg-opacity-40  p-5 rounded-xl border border-solid border-shark-300 w-full md:max-w-[362px] 2xl:min-w-[362px] min-h-[216px] max-h-[240px]">
