...
const Partners = () => {
  ...
  return (
    <div className="relative container flex items-center flex-col justify-center mt-[120px]">
      <div className='lg:absolute lg:top-[100px] lg:transform lg:left-1/2 lg:-translate-x-1/2  flex flex-col items-center justify-center mx-auto'>
