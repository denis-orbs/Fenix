...
const RewardNow = ({ openModal, setOpenModal, activeVote }: RewardNowProps) => {
  ...
  return (
    <StepBox>
      <div className="flex flex-col justify-center w-full 2xl:py-6 relative z-10">
        ...
        <div className="flex flex-wrap xl:flex-nowrap gap-3 mt-3  items-center w-full">
          <div className="bg-shark-400 bg-opacity-40 text-sm rounded-lg  py-2 flex flex-col items-center justify-center w-full xl:w-1/2">
            <p className="text-shark-100">Fenix Balance</p>
            <p className="text-white text-2xl">0</p>
          </div>
          <div className="bg-shark-400 bg-opacity-40 rounded-lg text-sm  py-2 flex flex-col items-center w-full xl:w-1/2">
