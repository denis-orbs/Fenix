...
const GoldRushBanner = () => {
  ...
  return (
    <div className="blast-banner flex items-center overflow-hidden rounded-tl-[1.625rem] rounded-br-[1.625rem] rounded-tr-xl rounded-bl-xl">
      ...
      <Button variant="primary" className={`relative z-[20] max-lg:!px-2 max-lg:!py-1 !flex-shrink-0 max-sm:!text-xs max-lg:hidden whitespace-nowrap ${pathname === '/liquidity' ? '!hidden' : '!block'}`} href="/liquidity">
