...
const BlastBanner = () => {
  ...
  return (
    <div className="blast-banner max-lg:flex-col overflow-hidden rounded-tl-[26px] rounded-br-[26px] rounded-tr-xl rounded-bl-xl">
      ...
      <Image src={'/static/images/blast-point-banner/white-star.svg'} alt='White Star' className='max-xl:hidden w-[113px] h-[113px] absolute top-1/2 transform -translate-y-1/2 xl:right-[400px] right-[370px] z-[40]' width={10} height={10}/>
      <Image src={'/static/images/blast-point-banner/planet.svg'} alt='White Star' className='max-lg:hidden w-[21px] h-[21px] absolute bottom-3 left-[550px] z-[40]' width={10} height={10}/>
      <Image src={'/static/images/blast-point-banner/orange-star.svg'} alt='Orange Star' className='max-lg:hidden w-[310px] h-[228px] absolute -bottom-16 left-[600px] z-[40] mix-blend-lighten opacity-60' width={10} height={10}/>
