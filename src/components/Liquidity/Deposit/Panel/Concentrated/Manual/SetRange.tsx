    ...
    <div className="bg-shark-400 bg-opacity-40 py-[29px] px-[19px] border border-shark-950 rounded-[10px] mb-2.5">
      ...
      <div className="flex gap-[21px]">
        <Input 
          ...
          value={currentPercentage[0] == -1 && currentPercentage[1] == -1  ? "0" : formatNumber((isInverse ? 1/(price2 * multiplier) : price1 / multiplier), 6) as string} 
          onChange={(value: any) => {
        ...
        <Input 
          ...
          value={currentPercentage[0] == -1 && currentPercentage[1] == -1  ? "Infinity" : formatNumber((isInverse ? 1/(price1 * multiplier) : price2 / multiplier), 6) as string} 
          onChange={(value: any) => {
            value.target.value = value.target.value * multiplier
            handleMinMaxInput(value, !isInverse)
          }}
