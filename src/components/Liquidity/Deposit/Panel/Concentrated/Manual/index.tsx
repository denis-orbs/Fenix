...
const ConcentratedDepositLiquidityManual = ({
  ...
  return (
    <>
      ...
      <SetRange shownPercentage={shownPercentage} currentPercentage={currentPercentage} setCurrentPercentage={setCurrentPercentage} price1={rangePrice1} price2={rangePrice2}/>
      <TokensSelector
