...
const Item = () => {
  return (
    <div className="flex items-center w-full bg-shark-400 bg-opacity-40 border border-shark-300 py-6 rounded-md mb-4">
      <span className="text-white w-36 text-center flex items-center justify-center">
      ...
      <span className="text-white w-full">
        <div className="flex items-center gap-4">
          ...
          <p className="text-sm">0x938c3b4....1c35ab3281</p>
        </div>
      </span>
