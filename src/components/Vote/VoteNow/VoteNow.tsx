  ...
  return (
    <div className="relative">
      ...
      <StepBox className="xl:max-h-[336px] xl:min-h-[336px]">
        ...
        <div className="flex flex-col justify-center xl:min-h-[px] w-full  relative z-10 py-3 2xl:py-10">
          ...
          <div className="flex flex-wrap xl:flex-nowrap gap-3 mt-2 items-center w-full">
            ...
            <div className="flex flex-col gap-3 w-full ">
              <div className="box-vote-short">
                <div className="flex text-xs text-white p-2 justify-center items-center gap-3 ">
