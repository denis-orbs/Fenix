...
import { TableHead, TableBody, TableCell, TableRow, Button } from '@/src/library/components/UI'
import { TOKENS_LIST } from '../data'
import PaginationMobile from '@/src/library/components/UI/Pagination/PaginationMobile'
