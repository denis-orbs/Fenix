'use client'
import { Button, Modal } from '@/src/library/components/UI'
    ...
    <Modal openModal={openModal} setOpenModal={setOpenModal}>
      <div className="common-modal">
        ...
        <div className="relative z-10 w-auto h-auto">
          <h1 className="mb-6 text-xl text-center text-white line-clamp-2 md:line-clamp-3">Are you sure you would like to delete your strategy?</h1>
          <p className='text-white text-sm text-center px-6 mb-5 line-clamp-2 md:line-clamp-none'>Deleting your strategy will result in all strategy data being lost and impossible to restore. All funds will be withdrawn to your wallet.</p>
            <div className='flex items-center justify-between bg-shark-400  bg-opacity-40 p-2 py-4 rounded-xl '>
                <div className='px-3'>
                    ...
                    <p className='text-xs text-white font-light line-clamp-2 md:line-clamp-none'>Editing prices is cheaper and keeps your strategy working for you.</p>
