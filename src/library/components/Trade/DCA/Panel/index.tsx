...
import IWantToAllocate from '@/src/library/components/Trade/DCA/Panel/IWantToAllocate'
import ToBuy from '@/src/library/components/Trade/DCA/Panel/ToBuy'
import Frequency from '@/src/library/components/Trade/DCA/Panel/Frequency'
import AdvancedDCA from '@/src/library/components/Trade/DCA/Panel/AdvancedDCA'
import Summary from '@/src/library/components/Trade/DCA/Panel/Summary'
import Separator from '@/src/library/components/Trade/Common/Separator'

import { Button, Switch } from '@/src/library/components/UI'
