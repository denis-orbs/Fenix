...
import Panel from '@/src/library/components/Trade/DCA/Panel'
import Orders from '@/src/library/components/Trade/DCA/Orders'
import TradeProcess from '@/src/library/components/Trade/Common/TradeProcess'
import { DCA_PROCESS } from '../data'
import Chart from '@/src/library/components/Chart'
