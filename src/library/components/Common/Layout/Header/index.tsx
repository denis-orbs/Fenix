...
import WalletSelection from '@/src/library/components/Modals/WalletSelection'

const Header = () => {
  return (
    <header className="hidden mx-auto xl:block container">
      <div className="flex justify-between gap-5 rounded-lg bg-shark-400 bg-opacity-40 border border-shark-400">
