...
import Strategy from '@/src/library/components/Dashboard/MyStrategies/Strategy'
import StrategyMobile from './StrategyMobile'
import { Swiper, SwiperSlide } from 'swiper/react'
import type { Swiper as SwiperCore } from 'swiper'
import 'swiper/css'
import WithdrawFunds from '@/src/library/components/Modals/WithdrawFunds'
import DuplicateStrategy from '@/src/library/components/Modals/DuplicateStrategy'
import PauseStrategy from '@/src/library/components/Modals/PauseStrategy'
import ManageNotifications from '@/src/library/components/Modals/ManageNotifications'
import DeleteStrategy from '@/src/library/components/Modals/DeleteStrategy'
