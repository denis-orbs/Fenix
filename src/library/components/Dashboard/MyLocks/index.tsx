...
import Locks from '@/src/library/components/Lock/MyLocks'
import MylocksMobile from '@/src/library/components/Lock/Mobile/MylocksMobile'
import { LOCKS } from '@/src/library/components/Lock/data'
