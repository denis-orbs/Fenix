'use client'
import MainBox from '@/src/library/components/Common/Boxes/MainBox'
import Image from 'next/image'
import InputRange from '@/src/library/components/UI/SliderRange/InputRange'
import { Button, ProgressBar } from '@/src/library/components/UI'
import { useEffect, useState } from 'react'
import Filter from '@/src/library/components/Common/Filter'
import ActiveVote from '@/src/library/components/Vote/ActiveVote'
import SelectVote from '@/src/library/components/Modals/SelectVote'
import AboutFnx from '../AboutFnx'
import Merge from './Merge'
import Split from './Split'
import Transfer from './Transfer'
import ConfirmMerge from '@/src/library/components/Modals/ConfirmMerge'
import NotificationLock from '@/src/library/components/Lock/Notification'
