import { getTotalWeight } from '@/library/adapters/web3/vote/VoteManagementV3';
import { TokenData } from '@/library/structures/common/TokenData';
import { CHRTokenAddress } from '@/library/web3/ContractAddresses';
import { FETCH_LAST_EPOCH_BRIBES } from '../queries/BribesQueries';
import rewardsClient from '../RewardsClient';
import { BigDecimal } from '@/library/common/BigDecimal';
...
export async function getAverageVotignAPR(availableTokensDictionary: {
  ...
  try {
    ...
    const chrToken = availableTokensDictionary[CHRTokenAddress.toLowerCase()];
