'use client'
import MainBox from '@/src/app/components/Common/Boxes/MainBox'
import Image from 'next/image'
import InputRange from '@/src/app/components/UI/SliderRange/InputRange'
import { Button, ProgressBar } from '@/src/app/components/UI'
import { useEffect, useState } from 'react'
import Filter from '@/src/app/components/Common/Filter'
import ActiveVote from '@/src/app/components/Vote/ActiveVote'
import SelectVote from '@/src/app/components/Modals/SelectVote'
import AboutFnx from '../AboutFnx'
import Merge from './Merge'
import Split from './Split'
import Transfer from './Transfer'
import ConfirmMerge from '@/src/app/components/Modals/ConfirmMerge'
import NotificationLock from '@/src/app/components/Lock/Notification'
