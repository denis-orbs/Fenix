...
import { TableHead, TableBody, TableCell, TableRow, Button } from '@/src/app/components/UI'
import { TOKENS_LIST } from '../data'
import PaginationMobile from '@/src/app/components/UI/Pagination/PaginationMobile'
