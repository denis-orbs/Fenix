...
import Decorator from '@/src/app/components/Common/Layout/BackgroundLanding'
import useStore from '@/src/state/zustand'
import Blast from '@/src/app/components/UI/Icons/Blast'
            ...
            <div className="relative w-full">
              ...
              <div className="absolute max-xl:left-0 max-xl:top-0 max-xl:right-0 max-xl:bottom-0  xl:w-[1000px] xl:h-[701.41px]  xl:top-[-100px] xl:left-[-123px] 2xl:w-[1480px] 2xl:h-[1037.8px] 2xl:top-[-32px] pointer-events-none select-none">
                <video
                  ...
                  autoPlay
                  muted
                  className="absolute z-10 mix-blend-lighten left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 w-full"
                >
