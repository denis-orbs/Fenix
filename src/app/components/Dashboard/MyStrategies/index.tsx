...
import Strategy from '@/src/app/components/Dashboard/MyStrategies/Strategy'
import StrategyMobile from './StrategyMobile'
import { Swiper, SwiperSlide } from 'swiper/react'
import type { Swiper as SwiperCore } from 'swiper'
import 'swiper/css'
import WithdrawFunds from '@/src/app/components/Modals/WithdrawFunds'
import DuplicateStrategy from '@/src/app/components/Modals/DuplicateStrategy'
import PauseStrategy from '@/src/app/components/Modals/PauseStrategy'
import ManageNotifications from '@/src/app/components/Modals/ManageNotifications'
import DeleteStrategy from '@/src/app/components/Modals/DeleteStrategy'
