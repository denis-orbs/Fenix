...
import Locks from '@/src/app/components/Lock/MyLocks'
import MylocksMobile from '@/src/app/components/Lock/Mobile/MylocksMobile'
import { LOCKS } from '@/src/app/components/Lock/data'
