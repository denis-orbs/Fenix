  ...
  return (
    <StepBox>
      <div className="flex flex-col justify-center w-full rounded-2xl xl:rounded-none relative z-10">
        ...
        <div className="flex gap-3 p-1 mt-2">
          <div className="relative bg-shark-400 bg-opacity-40 rounded-xl pl-4 xl:pl-5 pr-4 xl:pr-3 py-3 text-sm flex flex-col items-center justify-center w-[30%]">
            <p className="text-shark-100">Fenix Balance</p>
            <p className="text-white text-2xl">0.00</p>
          </div>
          <div className="relative bg-shark-400 bg-opacity-40 rounded-xl pl-4 xl:pl-5 pr-4 xl:pr-3 py-3 text-sm flex flex-col  items-center w-[30%]">
