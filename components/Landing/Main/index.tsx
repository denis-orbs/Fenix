          ...
          <div className="flex max-xl:flex-col">
            ...
            <div className="relative w-full">
              <Image
                ...
                height={1359}
                alt="main-bg"
                className="relative xl:absolute -z-10 top-0 left-1/2 max-xl:-translate-x-1/2 xl:top-[-100px] 2xl:top-[-32px] xl:left-[-123px] min-w-[1480px] object-contain max-md:min-w-[556.986px] max2xl:min-w-[1200px] max-xl:object-contain"
              />
            </div>
          </div>
