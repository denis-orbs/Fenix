  ...
  return (
    <main>
      ...
      <div className="w-full relative">
        ...
        <div className="absolute left-1/2 -translate-x-1/2 top-[-100px] md:top-[-7px] z-50">
          <Image src="/static/images/landing/support/partners.svg" alt="img" width={366} height={143} className="" />
        </div>
