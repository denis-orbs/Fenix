    ...
    <li className="flex justify-between gap-3 items-center p-3 mb-3 relative bg-shark-400 bg-opacity-40 rounded-lg">
      <div className="flex items-center gap-3">
        <div className="flex items-center justify-center w-10 h-10 p-3 rounded-lg bg-shark-400 bg-opacity-60">
          <span
            className={`inline-block text-xl text-transparent bg-gradient-to-r from-outrageous-orange-500 to-festival-500 bg-clip-text icon-percentage`}
          ></span>
        </div>
        <div className="flex items-center gap-2">
          <p className="text-white text-sm">1.0%</p>
          <p className="text-shark-100 text-sm"> slippage applied</p>
        </div>
      </div>
