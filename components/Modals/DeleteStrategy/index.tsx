    ...
    <Modal openModal={openModal} setOpenModal={setOpenModal}>
      <div className="common-modal">
        ...
        <div className="relative z-10 w-auto h-auto">
          <h1 className="mb-10 text-2xl text-center text-white">Are you sure you would like to delete your strategy?</h1>
          <p className='text-white text-sm text-center px-6 mb-5'>Deleting your strategy will result in all strategy data being lost and impossible to restore. All funds will be withdrawn to your wallet.</p>
            ...
            <div className='mt-10'>
                <Button className='mx-auto !py-3'>Delete Strategy</Button>
            </div>
        </div>
      </div>
    </Modal>
