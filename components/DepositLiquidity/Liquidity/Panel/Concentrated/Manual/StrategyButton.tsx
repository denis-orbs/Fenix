  ...
  return (
    ...
    >
      <button
        ...
        className={`bg-limed-spruce-900 bg-opacity-40 px-5 pt-[17px] pb-[7px] rounded-[10px] border border-oxford-blue-900 w-full flex flex-col gap-1 items-center justify-center hover:bg-limed-spruce-950 mb-2.5 ${
